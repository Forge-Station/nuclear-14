...
public sealed partial class NcStoreHeaderBar : BoxContainer
{
    ...
    {
        _balanceTextColor = ThemeColor(colors.HeaderBalanceText, "#E4D8BC");
        EmptyBalanceLabel.FontColorOverride = _balanceTextColor;
        StoreTitle.FontColorOverride = ThemeColor(colors.TabFontActive, "#E4D3AF");

        SearchShell.PanelOverride = new StyleBoxFlat
        {
            BackgroundColor = ThemeColor(colors.SearchBoxBackground, "#232830"),
        ...
        SearchBar.ModulateSelfOverride = ThemeColor(colors.HeaderBalanceText, "#DDD5C7");
        SearchIcon.ModulateSelfOverride = ThemeColor(colors.SearchIconColor, "#D6C9A9");
