...
public sealed partial class NcContractCard : PanelContainer
{
    ...
    {
        var baseAccent = ThemeColor(_uiColors.CategoryButtonSelected, "#4F86B7");
        var accent = _data.Completed
            ? Dim(baseAccent, 0.55f)
            : baseAccent;

        var cardBackground = ThemeColor(_uiColors.ListingCardBackground, "#141A22");
        var cardBorder = ThemeColor(_uiColors.ListingCardBorder, "#314052");
        var sideBackground = ThemeColor(_uiColors.TabsFrameBackground, "#18202A");
        var secondaryText = ThemeColor(_uiColors.TabFontInactive, "#AEBBCC");
        var primaryText = ThemeColor(_uiColors.ListingTitleColor, "#DDD6C7");
        var progressTrackBg = ThemeColor(_uiColors.TabsShellBackground, "#0E1319");
        ...
        ProgressValueLabel.Modulate = ThemeColor(_uiColors.TabFontActive, "#D7E1EC");
        TurnInNoteLabel.Modulate = ThemeColor(_uiColors.HeaderBalanceText, "#C5D0DD");
        StageLabel.Modulate = ThemeColor(_uiColors.TabFontActive, "#89B2E1");
    }
