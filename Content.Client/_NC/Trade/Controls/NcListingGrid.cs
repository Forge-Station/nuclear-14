...
public sealed partial class NcListingGrid : BoxContainer
{
    ...
    public void ApplyUiTheme(StoreUiColorsData colors)
    {
        ...
        MessageLabel.ModulateSelfOverride = ThemeColor(_uiColors.TabFontInactive, "#B9AE95");
        MessagePanel.PanelOverride = new StyleBoxFlat
        {
    ...
    private static Color ThemeColor(string? value, string fallback)
    {
        if (!string.IsNullOrWhiteSpace(value))
        {
            ...
            {
                // Invalid YAML token should not break the list.
            }
        }
