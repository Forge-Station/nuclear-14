...
public sealed partial class NcCategoryButtonControl : Button
{
    ...
    private Color GetHoverSurface() => NcStoreUiTheme.Blend(NcStoreUiTheme.Blend(_surfaceBase, Color.White, 0.03f), _idleColor, 0.26f);

    private Color GetSelectedSurface() => NcStoreUiTheme.Blend(NcStoreUiTheme.Blend(_surfaceBase, _selectedColor, 0.18f), _selectedColor, 0.24f);
