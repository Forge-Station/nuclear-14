...
public sealed partial class NcStoreListingsView : PanelContainer
{
    ...
    public void ApplyUiTheme(StoreUiColorsData colors)
    {
        ...
        {
            BackgroundColor = NcStoreUiTheme.WithAlpha(NcStoreUiTheme.ResolveColor(_uiColors.CategoriesDivider, "#2E3640"), 0.22f)
        };
    ...
    private void UpdateCategoryHeaderStyle(bool isSelectedCategory)
    {
        ...
        CategoryHeaderPanel.PanelOverride = NcStoreUiTheme.Flat(background, border, new Thickness(0, 0, 0, 1));
