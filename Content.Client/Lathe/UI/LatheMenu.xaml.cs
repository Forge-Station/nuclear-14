...
public sealed partial class LatheMenu : DefaultWindow
{
    ...
    private bool IsBlueprintRecipe(LatheRecipePrototype recipe)
    {
        ...
        // Instead, use the explicit RequiresBlueprint flag: recipes unlocked only when the matching
        // blueprint is placed in the workbench storage set this to true and are shown in the
        // Blueprints sub-section with the item's actual material cost as the tooltip.
