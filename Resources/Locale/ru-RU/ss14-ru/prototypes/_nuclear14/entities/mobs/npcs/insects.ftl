...
ent-N14MobDesertRadscorpion = пустынный радскорпион
    .suffix = Радскорпион 
    .desc = Гигантский скорпион пустыни Мохаве, привыкший к палящему солнцу. Его яд способен убить за считанные минуты.
