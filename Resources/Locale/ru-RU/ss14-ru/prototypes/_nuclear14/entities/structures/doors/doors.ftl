...
ent-N14DoorWoodSecureNCR = укрепленная дверь
    ...
    .suffix = НКР
ent-N14DoorWoodSecureLegio = укрепленная дверь
    .desc = Укрепленная деревянная дверь с эмблемой быка.
    .suffix = Легион
ent-N14DoorWoodSecureWBOS = укрепленная дверь
    .desc = Укрепленная деревянная дверь с эмблемой Вашингтонского братства.
    .suffix = ВБС
ent-N14DoorWoodSecureWESTBOS = укрепленная дверь
    .desc = Укрепленная деревянная дверь с эмблемой Западного братства.
    .suffix = ЗБС
ent-N14DoorWoodSecureMIDWESTBOS = укрепленная дверь
    .desc = Укрепленная деревянная дверь с эмблемой Средне Западного братства.
    .suffix = СЗБС
