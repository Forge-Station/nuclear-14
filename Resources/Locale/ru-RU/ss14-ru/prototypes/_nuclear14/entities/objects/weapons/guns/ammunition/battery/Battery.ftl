...
ent-N14PlasmaCell = плазменная батарея
    .desc = Небольшой аккумулятор светящийся зеленым. Обычно используется для заряжания легкого плазменного оружия.
ent-N14PowerCellFusionCellAdvansed = продвинутая микроядерная батарея
    .desc = Компактный источник энергии для тяжелого энергетического оружия. Несет в себе внушительный заряд, поэтому зарядка будет идти долго.
