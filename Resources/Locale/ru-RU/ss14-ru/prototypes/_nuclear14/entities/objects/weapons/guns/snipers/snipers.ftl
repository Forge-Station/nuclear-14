...
ent-N14WeaponSniper308Tribal = племенная винтовка 
    .desc = Традиционная племенная винтовка с рычажным механизмом. Использует патроны калибра .45-70 Government.
ent-N14WeaponSniper308TribalUpgraded = снайперская племенная винтовка 
    .desc = Винтовка с рычажным механизмом, украшенная племенными-узорами. Использует патроны калибра .45-70 Government.
