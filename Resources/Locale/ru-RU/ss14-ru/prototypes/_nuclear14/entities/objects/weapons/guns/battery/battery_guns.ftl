...
ent-N14WeaponLaserGatlingSprtelWood = Гатлинг лазер Sprtel-Wood 9700
    .desc = Редчайшая версия гатлинг лазера. В этой модели сделали упор не на скорострельность, а на силу лазера. Использует продвинутые ядерные батареи.
