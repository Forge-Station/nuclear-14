...
ent-N14WeaponGaussRifle = винтовка Гаусса
    .desc = Это снайперская винтовка, использующая принцип магнитной индукции для разгона ферромагнитного снаряда, помещенного в ствол. Она отличается высоким уроном, большой дальностью стрельбы и высокой поражающей способностью.
