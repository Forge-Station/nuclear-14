ent-NCClothingBandageNCR = повязка NCR
    .desc = Стандартная повязка армии NCR.

ent-NCClothingBandageNCRRecruit = повязка рекрута NCR
...
ent-NCClothingCollarBoSSerf = Ошейник серфа СЗБС
    .desc = Кажется он позволит вам сбежать, целым
