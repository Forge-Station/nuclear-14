...
trait-name-N14ChineseAccent = Китайский акцент
trait-description-N14ChineseAccent =
    Ваша речь звучит с китайским колоритом: знакомые слова подменяются на пиньинь, а остальные слова «китайствуют» по звучанию.
