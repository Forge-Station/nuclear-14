# Грамматика глючных законов хламобота — копия шаблонов ion-storm-* под сеттинг Fallout
# (станция→убежище, экипаж/члены экипажа→обитатели пустоши, шаттл→винтокрыл, клоуны→рейдеры, главы→главари).
# FTL-плейсхолдеры и селекторы сохранены 1-в-1. Слова подставляются из датасетов N14JunkWord*.
# Ион-шторм использует свои ion-storm-* и не затронут.
n14-junk-you = ВЫ
