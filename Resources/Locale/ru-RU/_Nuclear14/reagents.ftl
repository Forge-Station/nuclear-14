...
reagent-name-nuka-cola-wild = Ядер-Кола «Дикая»
reagent-desc-nuka-cola-wild = Сливочный, насыщенный и пряный вкус с оттенками старого доброго корневого пива. Лёгкое покалывание на языке — фирменный эффект.
...
reagent-name-extract-glowpepper = сок светоперца
reagent-desc-extract-glowpepper = Светящийся перец. Что-то подсказывает: если его съесть, рот будет болеть. На вкус — как великолепное ядерное пламя.
...
reagent-desc-extract-pinyon = Сок из пиньона. Очень крепкий.
