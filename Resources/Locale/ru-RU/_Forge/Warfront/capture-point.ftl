capture-point-window-title-outpost = консоль захвата аванпоста
capture-point-window-title-citadel = консоль захвата цитадели
capture-point-owner-static-label = Владелец:
...
capture-point-faction-none = Нет

capture-point-no-faction = У вас нет фракции
capture-point-on-cooldown = Консоль недавно захватывали, подождите
capture-point-already-capturing = Захват уже идёт
